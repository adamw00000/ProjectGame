...
namespace GameLib.Tests
{
    internal static class Helper
    {
        public static GameRules GetDefaultRules(int teamsize = 5) =>
            new GameRules(boardWidth: 8, boardHeight: 8, goalAreaHeight: 2, teamSize: teamsize);

        public static GameRules GetOddSizeBoardRules(int teamsize = 5) =>
            new GameRules(boardWidth: 7, boardHeight: 7, goalAreaHeight: 2, teamSize: teamsize); //odd-sized board

        public static GameRules GetStaticDefaultRules(int teamsize = 5) =>
            new GameRules(boardWidth: 8, boardHeight: 8, goalAreaHeight: 2, teamSize: teamsize); //Nie ruszac

        public static GameRules GetAlwaysInvalidPieceRules(int teamsize = 5) =>
           new GameRules(boardWidth: 8, boardHeight: 8, goalAreaHeight: 2, teamSize: teamsize, pieceSpawnInterval: 500, maxPiecesOnBoard: 10, badPieceProbability: 1);

        public static GameRules GetAlwaysValidPieceRules(int teamsize = 5) =>
            new GameRules(boardWidth: 8, boardHeight: 8, goalAreaHeight: 2, teamSize: teamsize, pieceSpawnInterval: 500, maxPiecesOnBoard: 10, badPieceProbability: 0);
        ...
        public static GameRules GetAlwaysValidPieceRules() =>
            new GameRules(boardWidth: 8, boardHeight: 10, goalAreaHeight: 2, pieceSpawnInterval: 500, maxPiecesOnBoard: 10, badPieceProbability: 0);
